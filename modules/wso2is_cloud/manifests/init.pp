...
class wso2is_cloud inherits wso2base {
  ...
  $gateway_server_host   = hiera('wso2::gateway_server_host')
  $gateway_server_port   = hiera('wso2::gateway_server_port')
  $gateway_endpoint_http_host   = hiera('wso2::gateway_endpoint_http_host')
  $gateway_endpoint_https_host  = hiera('wso2::gateway_endpoint_https_host')
  $gateway_endpoint_http_port   = hiera('wso2::gateway_endpoint_http_port')
  $gateway_endpoint_https_port  = hiera('wso2::gateway_endpoint_https_port')
  $sso_idp_url                  = hiera('wso2::sso_idp_url')
